...
#basic flight control
    ...
    # time-of-day control
#time - of - day control
    def setTime(self, timeofday, is_enabled, start_datetime = "", is_start_datetime_dst = False, celestial_clock_speed = 1, update_interval_secs = 60, move_sun = True):
        """
        ...
        """
        self.client.call('setTime', timeofday, is_enabled, start_datetime, is_start_datetime_dst, celestial_clock_speed, update_interval_secs, move_sun)
...
#gets the static meshes in the unreal scene
    ...
    def setAgentPose(self, pose, ignore_collision, agent_name = ''):
        """
        Set the pose of the agent
        ...
        Args:
            pose (Pose): Desired Pose pf the agent
            ignore_collision (bool): Whether to ignore any collision or not
            agent_name (str, optional): Name of the agent to move
        """
        self.client.call('setAgentPose', pose, ignore_collision, agent_name)

    def getAgentPose(self, agent_name = ''):
        """
        The position inside the returned Pose is in the frame of the agent's starting point
        
        Args:
            agent_name (str, optional): Name of the agent to get the Pose of

        Returns:
            Pose:
        """
        pose = self.client.call('getAgentPose', agent_name)
    ...
    def getObjectPose(self, object_name):
        ...
        Returns:
            Pose:
        """
        pose = self.client.call('getObjectPose', object_name)
        return Pose.from_msgpack(pose)

    def getObjectPolygon(self, object_name):
        """
        The position inside the returned Pose is in the world frame
        ...
        Returns:
            Polygon: array<xyz>
        """
        return self.client.call('getObjectPolygon', object_name)

    def setObjectPose(self, object_name, pose, teleport = True):
        """
        ...
        """
        return self.client.call('setObjectPose', object_name, pose, teleport)
    ...
    def getObjectsByTag(self, tag = '.*'):
        ...
        Args:
            tag (str, optional): String to match actor names against, e.g. "Cylinder.*"

        Returns:
            list[str]: List containing all the names
        """ 
        return self.client.call('getObjectsByTag', tag)
    ...
    def destroyObject(self, object_name):
        ...
        """
        return self.client.call('destroyObject', object_name)
...
#Add new vehicle via RPC
    ...
    def addAgent(self, propertyInfo, agent_type):
        """
        Create Agent at runtime

        Args:
            propertyInfo (Json Object): properties of Agent
            agent_type (string): e.g. "teenager_female"

        Returns:
            bool: Whether Human was created
        """
        return self.client.call('addAgent', propertyInfo, agent_type)

    def addAgents(self, propertyInfo, agent_type):
        return self.client.call('addAgents', propertyInfo, agent_type)

    def removeAgents(self):
        return self.client.call('removeAgents')

    def pauseAgents(self):
        return self.client.call('pauseAgents', True)

    def pauseAgent(self, id):
        return self.client.call('pauseAgent', id, True)

    def resumeAgent(self, id):
        return self.client.call('pauseAgent', id, False)

    def resumeAgents(self):
        return self.client.call('pauseAgents', False)

    def moveAgent(self, id, pos, radius, speed):
        return self.client.call('move', id, pos, radius, speed)

    def moveByRoutePoints(self, id, posArray, radius, speed):
        return self.client.call('moveByRoutePoints', id, posArray, radius, speed)

    def getRoutePoints(self, st_pos, ed_pos):
        return self.client.call('getRoutePoints', st_pos, ed_pos)

    def getVisibleRange(self, id, dist):
        return self.client.call('getVisibleRange', id, dist)

    def getVisibleObjects(self, id, dist):
        return self.client.call('getVisibleObjects', id, dist)

    def createFire(self, pos):
        return self.client.call('createFire', pos)

    def startAlarm(self, tag, enable):
        return self.client.call('startAlarm', tag, enable)

    def getFirePoints(self):
        return self.client.call('getFirePoints')

    def isInNavigationArea(self, pos):
        return self.client.call('isInNavigationArea', pos)

    def getNavigationArea(self):
        return self.client.call('getNavigationArea')

    def getNearbyNavigationArea(self,pos,dist):
        return self.client.call('getNearbyNavigationArea',pos,dist)

    def isMoveCompleted(self, id):
        return self.client.call('isMoveCompleted', id)

    def setAction(self, id, action, animation='', destination=''):
        return self.client.call('setAction', id, action, animation, destination)

    def getAction(self, id):
        return self.client.call('getAction', id)

    def setAgentVisible(self, id, visible):
        return self.client.call('setAgentVisible', id, visible)

    def setBuildingStats(self, tag, name, count, actionCategory):
        return self.client.call('setBuildingStats', tag, name, count, actionCategory)

    def setGlobalText(self, text):
        return self.client.call('setGlobalText', text)

    def science_setHighlight(self, enable):
        return self.client.call('science_setHighlight', enable)

    def setAgentLabelVisible(self, id, visible):
        return self.client.call('setAgentLabelVisible', id, visible)

    def showAgentInfoBoard(self, visible):
        return self.client.call('showAgentInfoBoard', visible)

    def resetAgent(self, id, pos, action):
        return self.client.call('resetAgent', id, pos, action)

    def coord_sim2LLA(self, pos):
        lla = self.client.call('coord_sim2LLA', pos)
        return lla

    def coord_LLA2Sim(self, pos):
        return self.client.call('coord_LLA2Sim', pos)
